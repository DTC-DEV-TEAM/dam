                                    ...
                                    <table id="asset-items">
                                        <tbody id="bodyTable">
                                            ...
                                            <tr class="tbl_header_color dynamicRows">
                                                <th width="30%" class="text-center"><span style="color:red">*</span>{{ trans('message.table.item_description') }}</th>
                                        ...
                                        <tfoot>
                                            ...
                                            <tr id="tr-table1" class="bottom">
                                                <td colspan="6">
                                                    <a type="button" id="add-Row" name="add-Row" class="btn btn-primary add"><i class="fa fa-plus-circle" ></i> Add Item</a>
                                                </td>
