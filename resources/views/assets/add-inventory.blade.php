                                    ...
                                    //    console.log(e.item_type);
                                        ...
                                        // }else{
                                            var new_row = '<tr class="nr" id="rowid' + e.id + '" rows>' +
                                                ...
                                                '<td><input class="form-control" type="text" placeholder="(Year)" name="warranty_coverage[]" style="width:160px;" id="warranty_coverage" min="1" max="9999999999" step="1" onkeypress="return event.charCode >= 48 && event.charCode <= 57" oninput="validity.valid||(value=1);"></td>' +                                                                           
