                                    ...
                                    //    console.log(e.item_type);
                                        ...
                                        // }else{
                                            ...
                                            var new_row = '<tr class="nr" id="rowid' + e.id + '" rows>' +
                                                ...
                                                '<td><input class="form-control amount ginput text-center" placeholder="Value" type="text" name="value[]" id="value" readonly required min="1" min="0" max="9999999999"  value="' + e.item_cost + '"></td>' +                                           
