            ...
            <div class="row"> 
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control finput" value="{{(int) number_format(Crypt::decryptString($Header->salary_range_from)) .' - '. number_format((int) Crypt::decryptString($Header->salary_range_to))}}" aria-describedby="basic-addon1" readonly>                                                                                         
